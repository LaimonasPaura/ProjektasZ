 <footer class="page-footer dark-blue transparency">
  <div class="container">
    <div class="row">
      ...
      <div class="col l8 offset-l0 s12">
        <h5 class="white-text">Check Us on:</h5>
        <div class="rounded-social-buttons">
  <a class="social-button facebook" href="https://www.facebook.com/profile.php?id=100000163254321&ref=br_rs"></a>
